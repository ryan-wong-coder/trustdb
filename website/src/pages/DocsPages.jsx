...
export function SdkDocsPage({ route }) {
  return (
    <DocsShell route={route}>
      ...
      <section className="doc-section"><h2>安装</h2><p>首个公开测试版使用 SemVer 预发布标签。评估与集成项目应固定这个版本，不要依赖浮动的 <code>@latest</code>。</p><CodeBlock>go get github.com/ryan-wong-coder/trustdb@v1.0.0-beta</CodeBlock><Note tone="warn" title="版本状态"><code>v1.0.0-beta</code> 仍是测试版，升级前请阅读 Release 说明并重新运行集成测试。</Note></section>
