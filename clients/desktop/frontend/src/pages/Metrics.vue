...
const HIGHLIGHTS = [
  { name: 'trustdb_ingest_accepted_total',    label: 'claims accepted',    desc: '累计已受理 claim',         fmt: 'int' },
  { name: 'trustdb_ingest_rejected_total',    label: 'claims rejected',    desc: '累计拒绝 claim',           fmt: 'int' },
  { name: 'trustdb_batch_committed_total',    label: 'batches committed',  desc: '累计已承诺批次',           fmt: 'int' },
  { name: 'trustdb_batch_pending',            label: 'batch pending',      desc: '待承诺批次数量',           fmt: 'int' },
  { name: 'trustdb_anchor_published_total',   label: 'anchors published',  desc: '累计已发布锚点',           fmt: 'int' },
  { name: 'trustdb_anchor_pending',           label: 'anchor pending',     desc: '待锚定批次数量',           fmt: 'int' },
] as const
