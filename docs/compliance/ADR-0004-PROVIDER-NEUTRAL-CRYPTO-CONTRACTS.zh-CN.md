...
- #448：严格 SM2-SM3 已完成，见 [`ADR-0007`](ADR-0007-CANONICAL-SM2-SM3-SIGNATURES.zh-CN.md)；
...
- 当前只有 `INTL_V1` Provider 可用；#447/#448 已实现可独立测试的 SM3、RFC6962-SM3 和 canonical SM2-SM3 核心，但 `CN_SM_V1` 生产 Provider 仍被 registry gate 拒绝，等待 #454 的 V2 全链路切换；
