...
- proofstore 已持久化不可变 suite marker；SM3、RFC6962-SM3 和 suite-aware proof core 已由 #447 与 [`ADR-0006`](ADR-0006-SM3-AND-RFC6962-MERKLE-PROFILES.zh-CN.md) 实现，canonical SM2-SM3 已由 #448 与 [`ADR-0007`](ADR-0007-CANONICAL-SM2-SM3-SIGNATURES.zh-CN.md) 实现。server 仍需由 #454 将 suite 显式传播到全部 V2 业务对象后，才能启用 `CN_SM_V1` 端到端写路径。
