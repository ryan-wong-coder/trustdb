...
```text
GET /v2/anchor-systems
GET /v2/anchor-systems/{system_id}
GET /v2/anchor-systems/{system_id}/status
GET /v2/anchor-systems/{system_id}/resources?kind=&limit=&cursor=
GET /v2/anchor-systems/{system_id}/resources/{kind}/{resource_id}
```
