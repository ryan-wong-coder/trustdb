...
var registry = map[string]Descriptor{
	...
	ProofstoreV4: descriptor(FamilyProofstore, ProofstoreV4, 4, AvailabilityReserved, EncodingProofstore, []cryptosuite.ID{cryptosuite.INTLV1}, "", MigrationRetireOnCutover, 64<<20),
	ProofstoreV5: descriptor(FamilyProofstore, ProofstoreV5, 5, AvailabilityAvailable, EncodingProofstore, []cryptosuite.ID{cryptosuite.CNSMV1, cryptosuite.INTLV1}, "crypto_suite", MigrationDestructiveCutover, MaxStoredObjectBytesV2),

	HTTPV1: descriptor(FamilyHTTP, HTTPV1, 1, AvailabilityReserved, EncodingHTTPCBOR, []cryptosuite.ID{cryptosuite.INTLV1}, "", MigrationRetireOnCutover, 16<<20),
	HTTPV2: descriptor(FamilyHTTP, HTTPV2, 2, AvailabilityAvailable, EncodingHTTPCBOR, []cryptosuite.ID{cryptosuite.CNSMV1, cryptosuite.INTLV1}, "crypto_suite", MigrationDestructiveCutover, MaxTransportMessageBytesV2),
...
var modelSchemas = []SchemaTransition{
	{Artifact: "accepted_receipt", Current: "trustdb.accepted-receipt.v2"},
	{Artifact: "batch_manifest", Current: "trustdb.batch-manifest.v2"},
	{Artifact: "batch_root", Current: "trustdb.batch-root.v2"},
	{Artifact: "batch_tree_leaf", Current: "trustdb.batch-tree-leaf.v2"},
	{Artifact: "batch_tree_node", Current: "trustdb.batch-tree-node.v2"},
	{Artifact: "client_claim", Current: "trustdb.claim.v2"},
	{Artifact: "committed_receipt", Current: "trustdb.committed-receipt.v2"},
	{Artifact: "global_log_leaf", Current: "trustdb.global-log-leaf.v2"},
	{Artifact: "global_log_node", Current: "trustdb.global-log-node.v2"},
	{Artifact: "global_log_outbox", Current: "trustdb.global-log-outbox.v2"},
	{Artifact: "global_log_proof", Current: "trustdb.global-log-proof.v2"},
	{Artifact: "global_log_state", Current: "trustdb.global-log-state.v2"},
	{Artifact: "global_log_tile", Current: "trustdb.global-log-tile.v2"},
	{Artifact: "idempotency_decision", Current: "trustdb.idempotency-decision.v2"},
	{Artifact: "key_event", Current: "trustdb.key-event.v3"},
	{Artifact: "l5_coverage_checkpoint", Current: "trustdb.l5-coverage-checkpoint.v2"},
	{Artifact: "proof_bundle", Current: "trustdb.proof-bundle.v2"},
	{Artifact: "record_index", Current: "trustdb.record-index.v2"},
	{Artifact: "server_record", Current: "trustdb.server-record.v2"},
	{Artifact: "signed_claim", Current: "trustdb.signed-claim.v2"},
	{Artifact: "signed_tree_head", Current: "trustdb.signed-tree-head.v2"},
	{Artifact: "sth_anchor_latest", Current: "trustdb.sth-anchor-latest.v2"},
	{Artifact: "sth_anchor_latest_empty", Current: "trustdb.sth-anchor-latest-empty.v2"},
	{Artifact: "sth_anchor_result", Current: "trustdb.sth-anchor-result.v2"},
	{Artifact: "sth_anchor_schedule", Current: "trustdb.sth-anchor-schedule.v2"},
	{Artifact: "wal_checkpoint", Current: "trustdb.wal-checkpoint.v3"},
}
